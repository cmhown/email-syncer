    ...
    */
    'accounts' => [
        ...
        'outlook' => [// account identifier
            'host'  => env('OUTLOOK_IMAP_HOST', 'outlook.office365.com'),
            'port'  => env('OUTLOOK_IMAP_PORT', 993),
            'protocol'  => env('OUTLOOK_IMAP_PROTOCOL', 'imap'), //might also use imap, [pop3 or nntp (untested)]
            'encryption'    => env('OUTLOOK_IMAP_ENCRYPTION', 'ssl'), // Supported: false, 'ssl', 'tls', 'notls', 'starttls'
            'validate_cert' => env('OUTLOOK_IMAP_VALIDATE_CERT', true),
            'username' => env('OUTLOOK_IMAP_USERNAME', 'root@example.com'),
            'password' => env('OUTLOOK_IMAP_PASSWORD', ''),
            'authentication' => env('OUTLOOK_IMAP_AUTHENTICATION', 'oauth'),
        ],
        
        'gmail' => [ // account identifier
            'host'  => env('GMAIL_IMAP_HOST', 'localhost'),
            'port'  => env('GMAIL_IMAP_PORT', 993),
            'protocol'  => env('GMAIL_IMAP_PROTOCOL', 'imap'), //might also use imap, [pop3 or nntp (untested)]
            'encryption'    => env('GMAIL_IMAP_ENCRYPTION', 'ssl'), // Supported: false, 'ssl', 'tls', 'notls', 'starttls'
            'validate_cert' => env('GMAIL_IMAP_VALIDATE_CERT', true),
            'username' => env('GMAIL_IMAP_USERNAME', 'root@example.com'),
            'password' => env('GMAIL_IMAP_PASSWORD', ''),
            'authentication' => env('GMAIL__IMAP_AUTHENTICATION', 'oauth'),
        ],
